      ...
      <div className="relative flex items-center gap-2 py-2 text-xs">
        ...
        {showOption && (
          <div
            ...
            <NavLink
              to={`/profile/${user._id}`}
              className="flex  cursor-pointer gap-2 rounded-sm px-2  py-2 font-semibold hover:bg-clrFrenchGrey/20">
              <FontAwesomeIcon className="text-lg " icon={faCircleUser} />
              <p>My Profile</p>
            </NavLink>
            <div className="flex  cursor-pointer gap-2 rounded-sm px-2  py-2 font-semibold hover:bg-clrFrenchGrey/20">
